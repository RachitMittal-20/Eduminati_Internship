  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 dark:ring-offset-slate-950 dark:focus-visible:ring-blue-400",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-blue-300 bg-white hover:bg-blue-50 text-blue-600 dark:border-blue-800 dark:bg-slate-950 dark:hover:bg-slate-900",
        secondary: "bg-slate-200 text-slate-900 hover:bg-slate-300 dark:bg-slate-700 dark:text-white dark:hover:bg-slate-600",
        ghost: "hover:bg-blue-100 hover:text-blue-600 dark:hover:bg-slate-800 dark:hover:text-blue-400",
